...
velocidadeMedia = float(input('Digite a velocidade media da viagem (em km/h):'))

distância = tempoGasto *velocidadeMedia

litros = distância / 12

print("A quantidade de litros gastos é: {:.3f}".format(litros))
